...
// ---------------------------------------------------------------------
// Global core objects (defined in chu_init.cpp)
// ---------------------------------------------------------------------
 ...
 *  - send a one-line message via "uart"
 ...
 *  - debug_on() prints a 1-line message (a string plus 2 numbers)
 *********************************************************************/
...
#define bit_write(data, n, v)    ( (v) ? bit_set((data), n) : bit_clear((data), n) )
#define bit(n)                   (1UL << (n))
